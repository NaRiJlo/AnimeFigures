...
const mainImage = document.getElementById('miniimg');

// Получение элемента с маленькой картинкой
const smallImage = document.querySelector('.product .image img');

// Добавление обработчика события к маленькой картинке
smallImage.addEventListener('click', (event) => {
  // Сохранение исходного источника главной картинки
  const mainImageSource = mainImage.src;

  // Установка источника главной картинки на источник маленькой картинки
  mainImage.src = smallImage.src;

  // Установка источника маленькой картинки на исходный источник главной картинки
  smallImage.src = mainImageSource;

  // Возврат исходного источника главной картинки
  return smallImage;
});
